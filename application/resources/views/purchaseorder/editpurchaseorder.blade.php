    ...
    <div class="panel panel-default cls-panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group{!! $errors->has('vatTaxAmount') ? ' has-error' : '' !!}">
                {!! Form::label('vatTaxAmount', 'VAT Tax Amount') !!}
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    {!! Form::text('vatTaxAmount', null, ['class' => 'form-control','placeholder'=>'Tax ']) !!}
                </div>
                {!! $errors->first('vatTaxAmount', '<p class="help-block">:message</p>') !!}
            </div>
            <div class="form-group{!! $errors->has('prRequestNo') ? ' has-error' : '' !!}">
                {!! Form::label('prRequestNo', 'Based On Purchase Request') !!}
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-file"></i></span>
                    {!! Form::text('prRequestNo', null, ['class' => 'form-control','placeholder'=>'Request Number']) !!}
                </div>
